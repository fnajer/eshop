...
class Product {
  ...
  public static function getLatestProducts($count = self::SHOW_BY_DEFAULT) {
    ...
    // Указываем, что хотим получить данные в виде ассоц. массива
  ...
  /**
   * Возвращает массив товаров в указанной категории
  ...
  public static function createProduct($options) {
    ...
    // Подготовление и возврат результатов. Используется подготовленный запрос
    $result = $db->prepare($sql);
  ...
  public static function getImage($id)
  {
    ...
    // Возвращаем путь изображения-пустышки (заглушку)
    return $path . $noImage;
  }
